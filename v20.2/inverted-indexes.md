...
XXX: Find out what comparison operators are supported

For more information about spatial indexes, including examples, see [Spatial Indexes](spatial-indexes.html).
